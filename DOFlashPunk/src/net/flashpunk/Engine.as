package net.flashpunk
{
	...
	public class Engine extends MovieClip
	{
		 ...
		 * @param	troot			The value of root. Usually just pass "this".
		 * @param	width			The width of your game.
		 * @param	height			The height of your game.
		 * @param	frameRate		The game framerate, in frames per second.
		 * @param	fixed			If a fixed-framerate should be used.
		 */
		public function Engine(troot:DisplayObject, width:uint, height:uint, frameRate:Number = 60, fixed:Boolean = false) 
		{
			...
			troot.addEventListener(Event.ACTIVATE, onActivate);
			troot.addEventListener(Event.DEACTIVATE, onDeactivate);
